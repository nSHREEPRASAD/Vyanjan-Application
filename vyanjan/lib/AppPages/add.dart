                  ...
                  child: Card(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          Center(
                            child: imgPath==""? Icon(Icons.food_bank,size: sh*0.3,): Image.file(File(imgPath), height: sh*0.35, width: sw, fit: BoxFit.fill,)
                          ),
                          imgPath!=""?
                          Positioned(
                            top: sh*0.02,
                            ...
                            child: IconButton(
                              ...
                              icon: Icon(Icons.cancel,size: sh*0.05,color: Colors.black,)
                            )
                          ):
                          Text("")
                        ]
